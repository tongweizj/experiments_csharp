...
namespace Assign_05
{
    public partial class MedicalCost
    {
        public const string RetrainFilePath =  @"D:\Notes\10_Projects\A1_ABL01EP25_winter\212_Programming3\Lab\Assign05\insurance.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"sex", @"sex"),new InputOutputColumnPair(@"smoker", @"smoker"),new InputOutputColumnPair(@"region", @"region")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=13,NumberOfLeaves=4,FeatureFraction=0.99341726F,LabelColumnName=@"charges",FeatureColumnName=@"Features"}));
